...
```json
{
	...
	"data": {
		...
		"boardIds": [1222601478, 18231288114, 9876857688],
		"widgetId": 589401115,
		"viewMode": "widget",
		"editMode": true,
		...
		"permissions": {
			"approvedScopes": ["me:read", "boards:read", "docs:read", "workspaces:read", "users:read", "account:read", "updates:read", "assets:read", "tags:read", "teams:read", "webhooks:read"],
			"requiredScopes": ["me:read", "boards:read", "docs:read", "workspaces:read", "users:read", "account:read", "updates:read", "assets:read", "tags:read", "teams:read", "webhooks:read"]
		}
	},
	"requestId": "omcji7l"
}
