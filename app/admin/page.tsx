...
import { Button, Icon, IconButton, IconLink } from "@/components";
        ...
        <div id="admin-app">
            <header className="admin-header">
                <Flex align="center" gap={16}>
                    <Logo size={{ width: 180, height: 32 }} style="brand" loading="eager" />
                        ...
                        <div className="admin-section-header">
                            <div>
                                ...
                                <p className="admin-section-description">
                                    Define roles and their default hourly rates for time tracking.
                                </p>
                            </div>
                            <Button
                                leftSection={<Icon name="add" size={21} />}
                                variant="primary"
                        ...
                        {loading ? (
                            ...
                            <div className="empty-state">
                                ...
                                <p className="empty-state-description">
                                    Create your first role to start tracking time by role.
                                </p>
                                <Button variant="primary" onClick={() => handleOpenRoleModal()}>
                                    Create Role
                                </Button>
                            </div>
                        ) : (
                                    ...
                                    <div key={role.id} className="role-card">
                                        <div className="role-card-header">
                                            <div className="role-card-title">
                                                <div
                                                    ...
                                                    style={{
                                                        backgroundColor: role.color_hex || "#0073ea",
                                                    }}
                                                />
                                                <span className="role-card-name">{role.name}</span>
                                            </div>
                                            <span
                                                className={`role-card-status ${role.is_active ? "active" : "inactive"}`}
                                            >
                                        ...
                                        <div className="role-card-actions">
                                            ...
                                            <Tooltip label={role.is_active ? "Deactivate role" : "Role is inactive"}>
                                                ...
                                                >
                                                    <Icon
                                                        name={role.is_active ? "toggleOn" : "toggleOff"}
                                                        size={21}
                                                        filled={role.is_active}
                                                        color={
                                                            role.is_active
                    ...
                    <div className="admin-section">
                        <div className="admin-section-header">
                            <div>
                                ...
                                <p className="admin-section-description">
                                    Configure which boards sync time data to monday.com columns.
                                </p>
                            </div>
                        </div>
                        ...
                        {loading ? (
                            ...
                            <div className="empty-state">
                                ...
                                <p className="empty-state-description">
                                    Add a board configuration to start syncing time data.
                                </p>
                                <Button variant="primary" onClick={() => handleOpenBoardModal()}>
                                    ...
                                    <div key={board.board_id} className="board-card">
                                            ...
                                            <Flex align="center" gap="xs">
                                                <div
                                                    ...
                                                    style={{
                                                        ...
                                                        height: 10,
                                                        borderRadius: "50%",
                                                        backgroundColor: (board as any).sync_enabled
                                                            ? "var(--color--success-500)"
                                                            : "var(--color--error-500)",
                                                    }}
                                                />
                                                <span className="board-card-name">
                                                    {(board as any).monday_board?.name || board.board_id}
                                                </span>
                                            </Flex>
                                            <span
                                                className={`board-sync-badge ${board.sync_enabled ? "enabled" : "disabled"}`}
                                            >
                                                {board.sync_enabled ? "Sync Enabled" : "Sync Disabled"}
                                            </span>
                                        </div>
                                        <div className="board-card-details">
                                            ...
                                            <div className="board-detail-row">
                                                ...
                                                {(board as any).last_sync ? (
                                                    <span className="board-detail-value">
                                                        {new Date((board as any).last_sync).toLocaleString()}
                                                    </span>
                                                ) : (
                                                    <span className="board-detail-value">/</span>
                                                )}
                                            </div>
                                        ...
                                        <div className="board-card-actions">
                                            <Tooltip label="Synchronize board">
                                                <IconButton
                                                    variant="primary-muted"
                                                    onClick={() => handleSyncBoard(board.board_id)}
                                                    loading={syncingBoards[board.board_id]}
                                                >
                                                    <Icon
                                                        name="refresh"
                                                        size={21}
                                            ...
                                            <Tooltip label="Edit board details">
                                                <IconButton
                                                    variant="primary-muted"
                                                    onClick={() => handleOpenBoardModal(board)}
                                                >
                                            ...
                                            <Tooltip label="Delete board configuration">
                                                <IconButton variant="warning" onClick={() => handleDeleteBoard(board)}>
            ...
            >
                <Stack gap="md">
                    ...
                    <ColorInput
                        label="Color"
                        value={roleForm.color_hex}
                        onChange={(val) => setRoleForm({ ...roleForm, color_hex: val })}
                        format="hex"
                        swatches={[
                            "#0073ea",
                            "#00c875",
                    ...
                    <Group justify="flex-end" mt="md">
                        ...
                        <Button variant="primary" onClick={handleSaveRole} loading={savingRole}>
            ...
            <Modal
                ...
                title={editingBoard ? "Edit Board Configuration" : "Add Board Configuration"}
                size="lg"
            >
                <Stack gap="md">
                    <Group grow>
                    ...
                    <Box className="form-section">
                        ...
                        <Stack gap="sm">
                            <Switch
                                label="Enable Sync"
                                description="Master toggle for all sync operations"
                                checked={boardForm.sync_enabled}
                                onChange={(e) =>
                                    setBoardForm({
                                        ...boardForm,
                                        sync_enabled: e.currentTarget.checked,
                                    })
                                }
                            />

                            <Switch
                                label="Sync on Finalize"
                                description="Automatically sync when time entries are finalized"
                                checked={boardForm.sync_on_finalize}
                                onChange={(e) =>
                                    setBoardForm({
                                        ...boardForm,
                                        sync_on_finalize: e.currentTarget.checked,
                                    })
                                }
                                disabled={!boardForm.sync_enabled}
                            />

                            <Switch
                                label="Sync Budget Used"
                                description="Sync total expenditure (Total Cost) to a separate column"
                                checked={boardForm.sync_budget_used}
                                onChange={(e) =>
                                    setBoardForm({
                                        ...boardForm,
                                        sync_budget_used: e.currentTarget.checked,
                                    })
                                }
                                disabled={!boardForm.sync_enabled}
                            />
                            ...
                            <Switch
                                label="Sync Linked Items"
                                description="Trigger sync for items on a linked board"
                                checked={boardForm.sync_linked_items}
                                onChange={(e) =>
                                    setBoardForm({
                                        ...boardForm,
                                        sync_linked_items: e.currentTarget.checked,
                                    })
                                }
                                disabled={!boardForm.sync_enabled}
                            />

                            {boardForm.sync_linked_items && (
                                <TextInput
                                    label="Linked Board ID"
                                    placeholder="e.g., 987654321"
                                    value={boardForm.linked_board_id}
                                    onChange={(e) =>
                                        setBoardForm({
                                            ...boardForm,
                                            linked_board_id: e.target.value,
                                        })
                                    }
                                    description="The board where linked items (e.g. Budgets) are located"
                                />
                            )}
                        </Stack>
                    </Box>
                    ...
                    <Group justify="flex-end" mt="md">
                        <Button onClick={() => setBoardModalOpen(false)}>Cancel</Button>
                        <Button variant="primary" onClick={handleSaveBoard} loading={savingBoard}>
