/**
 * ⚠️ AUTO-GENERATED FILE - DO NOT MANUALLY EDIT ⚠️
 *
 ...
 *   npm run db:types
 *
 * ⚠️ DO NOT ADD CUSTOM TYPES HERE ⚠️
 *
 * Add custom type extensions to:
 *   - types/database.types.ts (for custom types)
 *   - types/index.ts (for convenient re-exports)
 *
 * Last generated: Run `npm run db:types` to update
 */
