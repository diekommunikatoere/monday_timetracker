-- Migration 007: Update finalize_time_entry RPC
-- Updates finalize_time_entry to accept an optional duration override
...
CREATE OR REPLACE FUNCTION finalize_time_entry(
    ...
    p_duration INTEGER DEFAULT NULL -- New optional parameter
)
RETURNS jsonb AS $$
