...
export const themeTokens: CSSVariablesResolver = (theme) => ({
	...
	light: {
		...
		"--color--background-backdrop": "rgb(from var(--color--tertiary-900) r g b / 0.7)",
		"--color--background-error": "var(--color--error-500)",
		"--color--background-success": "var(--color--success-500)",

		"--color--button-default-bg": "rgb(from var(--color--tertiary-950) r g b / 0.5)",
		"--color--button-default-bg-hover": "var(--color--tertiary-900)",
		"--color--button-default-border": "var(--color--tertiary-700)",
		...
		"--color--border-disabled": "var(--color--tertiary-800)",
		...
		"--color--text-on-secondary": "var(--color--secondary-100)",
		...
		"--color--text-on-error": "var(--color--error-950)",
		"--color--text-on-success": "var(--color--success-950)",
		...
		"--color--input-border-disabled": "var(--color--tertiary-800)",
		...
		"--color--table-border": "var(--color--tertiary-600)",
		"--color--table-row-background-striped": "rgb(from var(--color--tertiary-100) r g b / 0.1)",
		...
		"--color--table-row-background-highlighted": "var(--color--tertiary-900)",
		"--color--table-row-background-highlighted-hover": "var(--color--tertiary-800)",
	...
	dark: {
		...
		"--color--background-backdrop": "rgb(from var(--color--tertiary-100) r g b / 0.7)",
		"--color--background-error": "var(--color--error-700)",
		"--color--background-success": "var(--color--success-700)",

		"--color--button-default-bg": "rgb(from var(--color--tertiary-50) r g b / 0.5)",
		"--color--button-default-bg-hover": "var(--color--tertiary-200)",
		"--color--button-default-border": "var(--color--tertiary-300)",
		"--color--button-primary-bg": "var(--color--primary-500)",
		...
		"--color--border-disabled": "var(--color--tertiary-200)",
		...
		"--color--text-on-warning": "#ffffff",
		"--color--text-on-error": "var(--color--error-100)",
		"--color--text-on-success": "var(--color--success-200)",
		...
		"--color--table-border": "var(--color--tertiary-400)",
		"--color--table-row-background-striped": "rgb(from var(--color--tertiary-900) r g b / 0.1)",
		...
		"--color--table-row-background-highlighted": "var(--color--tertiary-100)",
