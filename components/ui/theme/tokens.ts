...
export const themeTokens: CSSVariablesResolver = (theme) => ({
	...
	light: {
		...
		"--color--button-default-bg": "color-mix(in srgb, var(--color--tertiary-950) 50%, transparent)",
	...
	dark: {
		...
		"--color--button-default-bg": "color-mix(in srgb, var(--color--tertiary-50) 50%, transparent)",
