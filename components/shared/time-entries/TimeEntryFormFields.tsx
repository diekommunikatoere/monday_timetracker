        ...
        <Flex direction="column" gap="md">
            ...
            <Flex gap="md">
                    ...
                    leftSection={
                        onStartTimeNowClick ? (
                            <Tooltip label="Jetzt" position="top" withArrow>
                                <IconButton
                                    variant="tertiary"
                                    onClick={onStartTimeNowClick}
                                    aria-label="Startzeit auf jetzt setzen"
                                >
                ...
                <TimeInput
                    ...
                    leftSection={
                        onEndTimeNowClick ? (
                            <Tooltip label="Jetzt" position="top" withArrow>
                                <IconButton
                                    variant="tertiary"
                                    onClick={onEndTimeNowClick}
                                    aria-label="Endzeit auf jetzt setzen"
                                >
                                    <Icon name="today" size={16} color="var(--color--text-secondary)" />
                                </IconButton>
                            </Tooltip>
                    ...
                    rightSection={
                        <Tooltip
                            label={isLocked ? "Endzeit fixiert (Live)" : "Endzeit fixieren"}
                            position="top"
                            withArrow
                        >
                            <IconButton
                                ...
                                aria-label="Endzeit fixieren"
                            >
                                <Icon
                                    name={isLocked ? "lock" : "unlock"}
                                    size={16}
                                    color={isLocked ? "var(--color--text-on-primary)" : "var(--color--text-secondary)"}
                                />
                            </IconButton>
                        </Tooltip>
                    }
                            ...
                            <Button
                                ...
                                style={{
                                    ...
                                    borderRadius:
                                        idx === 0
                                            ? "5px 0 0 5px"
                                            : idx === (quickAdjustments.add?.length || 1) - 1
                                              ? "0 5px 5px 0"
                                              : "0",
                                }}
            ...
            {roleSelector?.show && (
                <Select
                    ...
                    data={roleSelector.roles}
                    value={roleSelector.selectedRoleId}
                    onChange={(val) => roleSelector.onRoleChange(val || "")}
                    disabled={roleSelector.loading}
                    searchable
                />
            )}
